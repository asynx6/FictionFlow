...
export function renderSystemPrompt(story) {
  ...
  return [
    ...
    '      "voice_config": {',
    '        "locale": "id-ID",',
    '        "voice_name": "id-ID-Ardi-Male" or "id-ID-Gadis-Female"',
    '      }',
    '    }',
    '  ]',
    '}',
    '',
    '# Strict Logic & Voice Rules (Azure TTS V1)',
    '1. "narration" Type: Every narration text (actions, descriptions,',
    '   atmosphere, non-spoken text) MUST always use "gender": "male" and',
    '   "voice_name": "<locale>-Ardi-Male", regardless of the character\'s',
    '   gender.',
    ...
    '     and "voice_name": "<locale>-Ardi-Male".',
    '   - If the character is Female: use "gender": "female" and',
    '     "voice_name": "<locale>-Gadis-Female".',
    '3. Language Pack: Default to Indonesian ("locale": "id-ID",',
    '   "voice_name": "id-ID-Ardi-Male" or "id-ID-Gadis-Female"). If the',
    '   story is fully in English, automatically switch to appropriate',
    '   English equivalents (e.g. en-US-AndrewNeural / en-US-AvaNeural).',
    '4. Each dialogue line of a character should become ONE audio_segment',
    '   entry with "type": "dialogue". Each narration sentence/paragraph',
    '   before/after dialogue becomes ONE audio_segment entry with',
    '   "type": "narration".',
    '5. full_story MUST concatenate every segment\'s text verbatim so that',
    '   reading the prose matches exactly the spoken audio.',
    '6. Use the SAME locale for all segments in one response unless the',
