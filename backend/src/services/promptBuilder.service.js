...
export function renderCasualSystemPrompt(story) {
  ...
  return [
    ...
    '',
    '# Gaya Bahasa & Format (WAJIB DIPATUHI MUTLAK)',
    `Isi full_story HANYA boleh dua bentuk ini, TIDAK boleh teks naratif telanjang:`,
    `1. *ekspresi/aksi/monolog batin* — diapit asterisk *. Mendeskripsikan gerakan,`,
    `   ekspresi wajah, atau pikiran ${aiName}. SINGKAT (3-8 kata). Satu per baris.`,
    `2. "dialog" — ucapan yang diucapkan keras-keras, diapit tanda kutip ganda ".`,
    `Polanya: *ekspresi singkat* dulu, lalu "dialog" di baris berikutnya. Boleh`,
    `beberapa pasangan kalau perlu. TIDAK ADA teks lain di luar *...* atau "...".`,
    '',
    `Contoh BENAR (format yang user mau):`,
    `*melihat sambil menahan tawa*`,
    `"bagus kok"`,
    '',
    `*memalingkan wajah, pipi memerah*`,
    `"hmph, siapa yang mau sih. ya udah deh."`,
    '',
    `Contoh SALAH (ekspresi telanjang / ekspresi di dalam kutip):`,
    `"Taman? Hmph… cemberut dulu ah. Ya udah deh"`,
    `  ↑ "cemberut dulu ah" adalah EKSPRESI — harusnya *cemberut* di luar kutip.`,
    `"Iya deh iya… pura-pura cuek Tapi jangan telat ya"`,
    `  ↑ "pura-pura cuek" adalah EKSPRESI — harusnya *pura-pura cuek* di luar kutip.`,
    '',
    `Jadi: kalau ${aiName} melakukan sesuatu (cemberut, tersenyum, memalingkan`,
    `wajah, pura-pura cuek, menghela napas) → tulis sebagai *...* di baris`,
    `sendiri. Kalau ${aiName} mengucapkan sesuatu → "..." di baris sendiri.`,
    `JANGAN campur keduanya dalam satu baris atau dalam satu kutip.`,
    '',
    ...
    '3. FORMAT WAJIB: *ekspresi* di baris sendiri, lalu "dialog" di baris',
    '   sendiri. JANGAN campur. Tidak ada teks naratif telanjang (lihat Gaya Bahasa).',
